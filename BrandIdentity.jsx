  ...
  const ProductsData = [
    {
      ...
      description:
        "Creative and consistent visuals make your brand memorable and instantly recognizable.",
    },
    {
      id: 2,
      img: Img2,
      ...
      description:
        "Design that resonates builds trust, emotional connection, and long-term customer loyalty.",
    },
    {
      id: 3,
      img: Img3,
      title: "Create a Strong Visual Foundation",
      description:
        "A solid identity guides all future design, ensuring consistency and saving time.",
    },
  ];
...
<div className="video-container">
      <video autoPlay muted loop playsInline>
        <source src="/public/soham.mp4" type="video/mp4" />
  ...
  gradientWord="Design"
  subheading="MS Advertising is a creative branding agency driven by a passion for transforming brands into market-ready powerhouses. We specialize in building bold brand identities and crafting cohesive visual languages that not only capture attention but drive real impact. By aligning strategy with stunning design, we help brands achieve consistency across every touchpoint—and unlock meaningful, measurable growth."
...
<LogoStrip images={imgstrip}/>
  ...
  <div className="card-container font-saira">
