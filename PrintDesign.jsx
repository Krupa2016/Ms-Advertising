...
import Img1 from "./assets/Print/1.png";
import Img2 from "./assets/Print/2.png";
import Img3 from "./assets/Print/3.png";
...
const App = () => {
  ...
  const ProductsData = [
    {
      id: 1,
      img: Img1,
      title: "Reach Offline Audiences",
      description:
        "Print helps expand your brand presence beyond digital, tapping into new offline markets.",
    },
    {
      id: 2,
      img: Img2,
      ...
      description:
        "Printed materials are tangible and long-lasting—something your audience can revisit anytime.",
    },
    {
      id: 3,
      img: Img3,
      title: "Strengthen Brand Connection",
      description:
        "As physical touch points, they reflect your brand values and build a deeper emotional connection.",
    },
  ];
  ...
  heading="Print"
  gradientWord="Design"
  subheading="Still think print is outdated? Think again. In an increasingly digital world, MS Advertising brings the power of print back to life—creating tangible brand experiences that leave a lasting impression. As a forward-thinking print design agency, we specialize in producing visually striking, high-impact print materials that elevate brand presence. Our expert team crafts custom, detail-driven designs that not only capture attention but also build trust and reinforce brand credibility in every touchpoint."
