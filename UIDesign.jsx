...
import Img1 from "./assets/Ui-Design/1.png";
import Img2 from "./assets/Ui-Design/2.png";
import Img3 from "./assets/Ui-Design/3.png";
...
const App = () => {
  ...
  const ProductsData = [
    {
      ...
      description:
        "Use visuals to explain concepts quickly and intuitively.",
    },
    {
      id: 2,
      img: Img2,
      ...
      description:
        "Add personality and interactivity to digital assets with dynamic illustrations and icons.",
    },
    {
      id: 3,
      img: Img3,
      ...
      description:
        "Make your brand communication more eye-catching and memorable.",
    },
  ];
  ...
  heading="UI"
  gradientWord="Design"
  subheading="Who says visual appeal can't serve a purpose? MS Advertising brings form and function together through custom illustrations and iconography that do more than just decorate—they communicate, guide, and elevate. Our design solutions are thoughtfully created to enhance user experience, express brand personality, and create lasting impressions. The result? Visually rich assets that not only look exceptional but also support your brand’s growth and engagement goals."
