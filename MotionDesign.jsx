...
import Img1 from "./assets/MotionDesign/1.png";
import Img2 from "./assets/MotionDesign/2.png";
import Img3 from "./assets/MotionDesign/3.png";
...
const App = () => {
  ...
  const ProductsData = [
    {
      id: 1,
      img: Img1,
      title: "Stand Out with Memorable Visuals",
      description:
        "Motion design brings uniqueness to your brand, helping you stand out in a crowded market.",
    },
    {
      id: 2,
      img: Img2,
      title: "Tell Your Story Dynamically",
      description:
        "It serves as a storytelling tool, turning your brand narrative into engaging visual experiences.",
    },
    {
      id: 3,
      img: Img3,
      title: "Strengthen Visual Identity",
      description:
        "Motion adds consistency and depth to your brand, creating a lasting impression on your audience.",
    },
  ];
  ...
  heading="Motion"
  gradientWord="Design"
  subheading="Motion design is where creativity meets impact—and at MS Advertising, we bring your brand to life through movement. Our motion design team creates dynamic, story-driven visuals that capture attention and communicate your message with clarity and emotion. Whether it’s a sleek product demo, an engaging brand story, or animated social content, we craft motion assets that not only look stunning but drive real engagement and elevate your brand presence."
