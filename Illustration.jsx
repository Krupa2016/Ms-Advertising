  ...
  return (
    ...
    <div className="video-container">
      <video autoPlay muted loop playsInline>
        ...
        <Banner
        heading="Illustration and "
        gradientWord="Iconography"
        subheading="Designs should do more than just look good—they should work hard for your brand. MS Advertising creates bespoke illustrations and iconography that combine style with strategy, helping you communicate clearly while standing out visually. From enriching user interfaces to enhancing brand storytelling, our visual assets are crafted to create immersive experiences that leave a lasting impact and drive meaningful engagement."
