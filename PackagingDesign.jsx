...
import Img1 from "./assets/Packaging/1.png";
import Img2 from "./assets/Packaging/2.png";
import Img3 from "./assets/Packaging/3.png";
  ...
  const ProductsData = [
    {
      ...
      description:
        "Stand out on shelves with eye-catching, unique visuals that grab your audience’s interest.",
    },
    {
      id: 2,
      img: Img2,
      title: "Reflect Brand & Product Quality",
      description:
        "Visually communicate the personality and quality of your product to build trust.",
    },
    {
      id: 3,
      img: Img3,
      ...
      description:
        "Clearly showcase your product’s unique selling points to stand apart from competitors.",
    },
  ];
  ...
  return (
    <div className=" dark:bg-gray-900 dark:text-white duration-200">
     ...
     <div className="video-container">
      ...
      <Banner
  heading="Packaging "
  gradientWord="Designing"
  subheading="At MS Advertising, we believe great packaging goes beyond just looking good—it plays a crucial role in a product’s success. Our design team brings creativity and strategy together to craft packaging that not only stands out on the shelf but also tells your product’s story. With a perfect balance of visual appeal and functional design, we help brands create packaging that captures attention, builds trust, and keeps customers coming back."
