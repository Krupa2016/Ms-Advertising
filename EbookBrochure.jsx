...
import Img1 from "./assets/Ebook/1.png";
import Img2 from "./assets/Ebook/2.png";
import Img3 from "./assets/Ebook/3.png";
...
const App = () => {
  ...
  const ProductsData = [
    {
      ...
      description:
        "Ebooks and brochures bring your brand narrative to life through compelling design.",
    },
    {
      id: 2,
      img: Img2,
      title: "Engage Through Visual Storytelling",
      description:
        "They present information in a captivating, easy-to-digest visual format that holds attention.",
    },
    {
      id: 3,
      img: Img3,
      title: "Build Trust and Recall",
      description:
        "By reflecting your brand’s design language, they boost credibility and make your brand more memorable.",
    },
  ];
  ...
  return (
    ...
    <div className="video-container">
      ...
      <Banner
  heading=" Ebook and "
  gradientWord="Brochures"
  subheading="Ebooks and brochures are powerful storytelling tools when done right. At MS Advertising, we design high-impact, brand-aligned digital and print materials that go beyond just presenting information—they communicate your message with clarity, style, and purpose. Our team thoughtfully combines structured content with compelling visuals like infographics, illustrations, and icons to create an immersive reading experience. The result? Brochures and ebooks that reflect your brand voice, engage your audience, and leave a lasting impression."
...
<LogoStrip images={imgstrip}/>
  ...
  <div className="card-container">
    ...
    <HorizontalCard cards={featuredCards} />
      ...
      <GetInTouch
        headingText="It's Your Time To Take-off!"
